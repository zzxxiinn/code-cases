...
# Setting WSL proxy with using host proxy port
# Usage:
#   - ./proxy.sh display  -> show current proxy setting
#   - ./proxy.sh set      -> set proxy
#   - ./proxy.sh unset    -> unset proxy
#   - ./proxy.sh git      -> set git proxy
#   - ./proxy.sh ungit    -> unset git proxy
